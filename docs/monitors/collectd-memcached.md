...
Monitor Type: `collectd/memcached` (<a target="_blank" href="https://github.com/signalfx/signalfx-agent/tree/master/internal/monitors/collectd/memcached">Source</a>)
...
Monitors an instance of memcached using the <a target="_blank" href="https://collectd.org/wiki/index.php/Plugin:memcached">collectd memcached plugin</a>.  Requires
