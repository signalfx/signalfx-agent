...
func (c *Config) Help() map[string]string {
	return map[string]string{
		...
		"SendMachineID":       "Whether to send the machine-id dimension on all host-specific datapoints generated by the agent.  This dimension is derived from the Linux machine-id value",
		"Observers":           "A list of observers to use (see observer config)",
		"Monitors":            "A list of monitors to use (see monitor config)",
		"BundleDir":           "Path to the directory holding the agent dependencies.  This will normally be derived automatically. Overrides the envvar SIGNALFX_BUNDLE_DIR if set.",
	}
}
