...
Monitor Type: `collectd/redis` (<a target="_blank" href="https://github.com/signalfx/signalfx-agent/tree/master/internal/monitors/collectd/redis">Source</a>)
...
Monitors a redis instance using the <a target="_blank" href="https://github.com/signalfx/redis-collectd-plugin">collectd Python Redis plugin</a>.  Supports Redis
2.8 and later.
