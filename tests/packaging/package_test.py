...
OLD_INSTALL_COMMAND = {
    ".rpm": "yum install -y https://dl.signalfx.com/rpms/signalfx-agent/release/signalfx-agent-3.0.1-1.x86_64.rpm",
    ".deb": "bash -ec 'wget -nv https://dl.signalfx.com/debs/signalfx-agent/release/pool/signalfx-agent_3.0.1-1_amd64.deb && dpkg -i signalfx-agent_3.0.1-1_amd64.deb'",
}
