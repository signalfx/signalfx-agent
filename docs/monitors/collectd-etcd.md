...
Monitor Type: `collectd/etcd` (<a target="_blank" href="https://github.com/signalfx/signalfx-agent/tree/master/internal/monitors/collectd/etcd">Source</a>)
...
Monitors an etcd key/value store using the <a target="_blank" href="https://github.com/signalfx/collectd-etcd">collectd etcd Python plugin</a>.
