...
if [ "$CIRCLE_BRANCH" != "master" ]; then
    if ! scripts/changes-include-dir deployments/${DEPLOYMENT_TYPE} tests/deployments/${DEPLOYMENT_TYPE} tests/packaging/common.py tests/requirements.txt ${BASH_SOURCE[0]}; then
