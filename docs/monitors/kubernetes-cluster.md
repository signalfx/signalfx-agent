...
(*default*) are ***in bold and italics*** in the list below.
 ...
 - `kubernetes.container_cpu_limit` (*gauge*)<br>    Maximum CPU limit set for the container
 - `kubernetes.container_cpu_request` (*gauge*)<br>    CPU requested for the container
 - `kubernetes.container_memory_limit` (*gauge*)<br>    Maximum memory limit set for the container
 - `kubernetes.container_memory_request` (*gauge*)<br>    Memory requested for the container
