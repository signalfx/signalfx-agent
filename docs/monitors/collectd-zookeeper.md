...
Monitor Type: `collectd/zookeeper` (<a target="_blank" href="https://github.com/signalfx/signalfx-agent/tree/master/internal/monitors/collectd/zookeeper">Source</a>)
...
Monitors an Apache Zookeeper instance using the <a target="_blank" href="https://github.com/signalfx/collectd-zookeeper">Zookeeper collectd plugin</a>. This plugin is
