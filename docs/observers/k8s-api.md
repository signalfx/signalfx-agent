...
| `node_metadata` | `string` | The metadata about the Node, for `k8s-node` targets, with fields in TitleCase.  See <a target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#objectmeta-v1-meta">ObjectMeta v1 meta reference</a>. |
| `node_spec` | `string` | The Node spec object, for `k8s-node` targets.  See <a target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#nodespec-v1-core">the K8s reference on this resource</a>, but keep in the mind that fields will be in TitleCase due to passing through Go. |
| `node_status` | `string` | The Node status object, for `k8s-node` targets. See <a target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#nodestatus-v1-core">the K8s reference on Node Status</a> but keep in mind that fields will be in TitleCase due to passing through Go. |
