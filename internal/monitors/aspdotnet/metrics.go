...
// GAUGE(asp_net.requests_current): Current number of ASP.NET requests.
...
// GAUGE(asp_net_applications.errors_unhandled_during_execution_sec): Unhandled error rate per second
// countered while an ASP.NET application is running.
...
// GAUGE(asp_net_applications.session_sql_server_connections_total): Number of connections to microsoft
// sql server by an ASP.NET application.

// GAUGE(asp_net_applications.sessions_active): Number of active sessions in the ASP.NET application.
