...
| `solo` | no | bool | If one or more configurations have this set to true, only those configurations will be considered. This setting can be useful (**default:** `false`) |
| `metricsToExclude` | no | [list of objects (see below)](#metricstoexclude) | A list of metric filters |
