...
type ConfigSource interface {
	...
	// not supported.  Get should return os.ErrNotExist if the path does not
	// exist in the source so that the agent can distinguish that from other
	// errors to allow for optional paths.
