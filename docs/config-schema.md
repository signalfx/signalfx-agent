...
```yaml
  ...
  writer: 
    ...
    datapointSendIntervalSeconds: 5
    eventSendIntervalSeconds: 5
    logDatapoints: false
    logEvents: false
  logging: 
    level: "info"
