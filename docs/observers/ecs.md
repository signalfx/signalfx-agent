...
# ecs
 ...
 Queries the <a target="_blank" href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-metadata-endpoint-v2.html">ECS Task Metadata Endpoint version 2</a> for running containers.
...
<a target="_blank" href="https://github.com/signalfx/signalfx-agent/tree/master/pkg/observers/ecs">Observer Source Code</a>
