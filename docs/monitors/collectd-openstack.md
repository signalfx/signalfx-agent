...
Monitor Type: `collectd/openstack` (<a target="_blank" href="https://github.com/signalfx/signalfx-agent/tree/master/internal/monitors/collectd/openstack">Source</a>)
...
Monitors <a target="_blank" href="https://www.openstack.org/">Openstack</a> by using the <a target="_blank" href="https://github.com/signalfx/collectd-openstack">Openstack collectd Python plugin</a>,
...
Please see the reference for OpenStack <a target="_blank" href="https://wiki.openstack.org/wiki/Operations/Monitoring">Monitoring</a>.
