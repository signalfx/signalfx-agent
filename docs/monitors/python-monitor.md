...
| `pythonPath` | no | `list of strings` | The PYTHONPATH that will be used when importing the script specified at `scriptPath`.  The directory of `scriptPath` will always be included in the path. |
