...
| `solo` | `false` | no | `bool` | If one or more configurations have this set to true, only those configurations will be considered considered. This setting can be useful |
