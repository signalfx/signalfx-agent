...
type Monitor struct {
	...
	ctx    context.Context
	// lastBuildSent map (key:job_name and value:build_completion_time) used to keep track of processed builds
	lastBuildSent map[string]int64
}
...
func (m *Monitor) Configure(conf *Config) error {
	...
	m.lastBuildSent = make(map[string]int64)
	...
	// this anonymous func creates a jenkins client for each metrics.
