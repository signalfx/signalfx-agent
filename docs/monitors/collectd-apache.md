...
Monitor Type: `collectd/apache` (<a target="_blank" href="https://github.com/signalfx/signalfx-agent/tree/master/internal/monitors/collectd/apache">Source</a>)
...
`metricsToInclude` config option to override that whitelist (see <a target="_blank" href="../legacy-filtering.md#inclusion-filtering">Inclusion
filtering</a>.  Or you can just
