...
| `traceHostCorrelationMaxRequestRetries` | no | unsigned integer | How many times to retry requests related to trace host correlation (**default:** `100`) |
...
```yaml
  ...
  writer: 
    ...
    traceHostCorrelationMaxRequestRetries: 100
